...
map.getView().fit([8917950.239105, 1448917.727466, 8959988.082369, 1486410.054035], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GCC- Women Safety Study- LUX Score</h2>';
        return titleElement;
    })(),
